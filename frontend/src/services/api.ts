...
const API_URL = import.meta.env['VITE_API_URL'] || 'https://ytsummarizer-production-860a.up.railway.app';
//const API_URL = 'https://ytsummarizer-production-860a.up.railway.app';
